defmodule Fibril.CoreComponents do
  @moduledoc """
  ...
  def table(assigns) do
    ...
    ~H"""
      <div class="relative divide-y divide-gray-200 overflow-x-auto dark:divide-white/10 dark:border-t-white/10 bg-white m-8  border border-gray-200 rounded-lg">
      <table class="table table-auto">

      <thead class="text-sm bg-gray-50 text-black">
      <tr class="p-0">
            <th :for={col <- @col} class="text-sm bg-gray-50 text-black"><%= col[:label] %></th>
